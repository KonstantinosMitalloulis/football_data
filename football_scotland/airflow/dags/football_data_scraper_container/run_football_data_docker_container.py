...
def run_football_data_docker_container(**kwargs):
    ...
    image = "kostasmitalloulis/football_data_scraper_image"
    
    # Pull the image from Docker Hub
    client.images.pull(image)

    # Define the path on the host and the path inside the container
    host_directory = "C:/Users/efsta/Desktop/Kostas/Data/football_scotland/airflow/dags/football_data_scraper_container/csv"  # Adjust this to your local directory
    ...
    container_name = "football_data_scraper_container"
    ...
    container = client.containers.run(
        ...
        detach=True  # Detach to run in the background
    )
...
if __name__ == "__main__":
    run_football_data_docker_container()