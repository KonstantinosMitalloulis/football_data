...
def run_docker_container(**kwargs):
    ...
    image = "kostasmitalloulis/sofascore_scraper_image"
    
    # Pull the image from Docker Hub
    client.images.pull(image)

    # Define the path on the host and the path inside the container
    host_directory = "C:/Users/efsta/Desktop/Kostas/Data/football_scotland/airflow/dags/sofascore_scraper_container/csv"  # Adjust this to your local directory
    ...
    container_name = "sofascore_scraper_container"
